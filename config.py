...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7296600633:AAG_j0fCt5M5NCfR8nCXQuXxluaPJPsw3GY")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002205464573"))
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "94c00a5aba3f792a0aba687b9257e83d9db957ed")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 300)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID","https://t.me/shortner_solver/9")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002131816362"))
...
try:
    ADMINS=[7121494638]
    for x in (os.environ.get("ADMINS", "7121494638").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>» ʙʏ @heanime_hub</b>")
...
USER_REPLY_TEXT = "ʙᴀᴋᴋᴀ ! ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴍʏ ꜱᴇɴᴘᴀɪ!!\n\n» ᴍʏ ᴏᴡɴᴇʀ : @Paradox_bots"

ADMINS.append(OWNER_ID)
ADMINS.append(7121494638)
